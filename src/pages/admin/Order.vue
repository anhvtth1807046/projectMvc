  ...
  <q-page class="q-pa-sm">
    <q-card class="q-mt-lg">
      <q-card-section class="q-pa-none">
        <q-table :data="data" :columns="columns" :filter="filter" row-key="name" title="Order">
          ...
          <template v-slot:body-cell-Action="props">
            <q-td :props="props">
              <q-btn-dropdown icon="edit" size="sm" flat dense>
                <q-list>
              ...
              <q-btn icon="remove_red_eye" size="sm" flat dense @click="handleShow(props.row)" />
              <q-btn
                icon="delete"
                size="sm"
                class="q-ml-sm"
